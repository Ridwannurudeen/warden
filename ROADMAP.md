...
| Correct live x402 domain | Source and fixtures use 0.1 USDT and `{"name":"USD₮0","version":"1"}`. | The 2026-07-18 read-only probe still observed live `{"name":"USDT","version":"1"}`. Deploy and reprobe before claiming payable authorization or settlement correctness. | **SOURCE READY / EXTERNAL, OPERATOR, OR TIME DEPENDENT** |
